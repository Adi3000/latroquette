 ...
 */
public class BOSHPacketReaderExtended implements BOSHClientExtendedResponseListener {

    private BOSHConnectionExtended connection;
     ...
     */
    public BOSHPacketReaderExtended(BOSHConnectionExtended connection) {
