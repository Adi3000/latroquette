...
import com.kenai.jbosh.BOSHClientExtended;
import com.kenai.jbosh.BOSHClientExtendedConnEvent;
import com.kenai.jbosh.BOSHClientExtendedConnListener;
import com.kenai.jbosh.BOSHClientExtendedRequestListener;
import com.kenai.jbosh.BOSHClientExtendedResponseListener;
import com.kenai.jbosh.BOSHException;
import com.kenai.jbosh.BOSHMessageEventExtended;
import com.kenai.jbosh.BodyQName;
import com.kenai.jbosh.ComposableBody;

public class BOSHConnectionExtended extends Connection {
     ...
     */
    private BOSHClientExtended client;
     ...
     */
    public BOSHConnectionExtended(boolean https, String host, int port, String filePath, String xmppDomain) {
     ...
     */
    public BOSHConnectionExtended(BOSHConfiguration config) {
        super(config);
        this.config = config;
    }
    ...
    public void connect() throws XMPPException {
        ...
        try {
            ...
            client = BOSHClientExtended.create(cfgBuilder.build());
            ...
            client.addBOSHClientResponseListener(new BOSHPacketReaderExtended(this));
    ...
    protected void initDebugger() {
        ...
        client.addBOSHClientResponseListener(new BOSHClientExtendedResponseListener() {
            public void responseReceived(BOSHMessageEventExtended event) {
        ...
        client.addBOSHClientRequestListener(new BOSHClientExtendedRequestListener() {
            public void requestSent(BOSHMessageEventExtended event) {
                if (event.getBody() != null) {
                    try {
     ...
     */
    private class BOSHConnectionListener implements BOSHClientExtendedConnListener {

        private final BOSHConnectionExtended connection;

        public BOSHConnectionListener(BOSHConnectionExtended connection) {
         ...
         */
        public void connectionEvent(BOSHClientExtendedConnEvent connEvent) {
            try {
