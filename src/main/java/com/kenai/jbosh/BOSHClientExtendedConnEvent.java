 ...
 */
public final class BOSHClientExtendedConnEvent extends EventObject {
     ...
     */
    private BOSHClientExtendedConnEvent(
            final BOSHClientExtended source,
     ...
     */
    static BOSHClientExtendedConnEvent createConnectionEstablishedEvent(
            final BOSHClientExtended source) {
        return new BOSHClientExtendedConnEvent(source, true, null, null);
    }
     ...
     * @return event instance
     */
    static BOSHClientExtendedConnEvent createConnectionClosedEvent(
            final BOSHClientExtended source) {
        return new BOSHClientExtendedConnEvent(source, false, null, null);
    }
     ...
     * @return event instance
     */
    static BOSHClientExtendedConnEvent createConnectionClosedOnErrorEvent(
            final BOSHClientExtended source,
            final List<ComposableBody> outstanding,
            final Throwable cause) {
        return new BOSHClientExtendedConnEvent(source, false, outstanding, cause);
    }
     ...
     */
    public BOSHClientExtended getBOSHClient() {
        return (BOSHClientExtended) getSource();
    }
