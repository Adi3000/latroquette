 ...
 */
public final class BOSHMessageEventExtended extends EventObject {
     ...
     */
    private BOSHMessageEventExtended(
            final Object source,
     ...
     */
    static BOSHMessageEventExtended createRequestSentEvent(
            final BOSHClientExtended source,
            final AbstractBody body) {
        return new BOSHMessageEventExtended(source, body);
    }
     ...
     * @return event instance
     */
    static BOSHMessageEventExtended createResponseReceivedEvent(
            final BOSHClientExtended source,
            final AbstractBody body) {
        return new BOSHMessageEventExtended(source, body);
    }
